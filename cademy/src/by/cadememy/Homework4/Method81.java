...
public class Method81<T extends Object> {
	...
	// 1.1 метод добавления элемента в конец массива (в первое пустое место) и
	// увеличения при необходимости размера
	@SuppressWarnings("unchecked")
	...
	// 1.2 метод добавления элемента в начало массива и увеличения при необходимости
	// размера
	@SuppressWarnings("unchecked")
